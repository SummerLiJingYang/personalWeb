...
public class CKEditorUploadServlet extends HttpServlet {   
    ...
    public void init() throws ServletException {   
    	try{
            ...
            if (debug) System.out.println("mode__________"+debug);
            if (debug)   
                System.out   
            ...
            if (baseDir == null)   
                baseDir = "/UserFiles/";   
            if (debug) System.out.println("baseDir:"+baseDir);
            String root = getServletContext().getRealPath("/");
            String realBaseDir = root+baseDir;
            if (debug) System.out.println("realBaseDir:"+realBaseDir);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)   
    	...
    	try{
            ...
            String img_domain = cfg.getString("img.domain");
